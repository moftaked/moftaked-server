...
async function getAttendance(eventOccurrenceId: number, type: 'student' | 'teacher') {
...
async function patchAttendance(attended: number[] | undefined, absent: number[] | undefined, eventOccurrenceId: number, type: 'student' | 'teacher') {
