...
async function createEvent(classId: number, eventName: string, type: eventTypes) {
  await executeQuery(`
...
export default { getEvents, createEventOccurrence, deleteLastEventOccurrence, createEvent, deleteEvent };